...
const styles = StyleSheet.create({
  container: { flex: 1 },
  h1: { color: '#fff', fontSize: 26, fontWeight: '800', marginVertical: 8 },
  h2: { color: '#fff', fontSize: 22, fontWeight: '700', marginVertical: 6 },
  h3: { color: '#ddd', fontSize: 18, fontWeight: '600', marginVertical: 4 },
  paragraph: { color: '#ccc', fontSize: 16, lineHeight: 26 },
  bulletRow: { flexDirection: 'row', alignItems: 'flex-start', marginVertical: 2 },
  bullet: { color: '#6c47ff', fontSize: 17, marginRight: 8, lineHeight: 26 },
  bulletText: { color: '#ccc', fontSize: 16, lineHeight: 26, flex: 1 },
  checkbox: { color: '#888', fontSize: 17, marginRight: 8, lineHeight: 26 },
